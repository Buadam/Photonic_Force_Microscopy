...
if ~isempty(psdx)
  ...
  title('PSDdata/PSDfit','FontSize',13,'fontWeight','bold')
  xlabel('f(Hz)')
  ylabel('Residual')
  hold off
  ...
  set(gca,'FontSize',12);
  hist(PSDres,100)
  title('PSD Residual Histogram','FontSize',13,'fontWeight','bold')   
...
if ~isempty(msdx)
  ...
  title('MSDdata/MSDfit','FontSize',13,'fontWeight','bold')
  xlabel('t(s)')
  hold off
  ...
  set(gca,'FontSize',12);
  hist(MSDres,100)
  title('MSD Residual Histogram','FontSize',13,'fontWeight','bold')
...
if ~isempty(vafx)  
  ...
  hold off
  title('VAFdata/VAFfit','FontSize',13,'fontWeight','bold')
  xlabel('t(s)')
  ...
  set(gca,'FontSize',12);
  hist(VAFres,100)
  title('VAF Residual Histogram','FontSize',13,'fontWeight','bold')   
